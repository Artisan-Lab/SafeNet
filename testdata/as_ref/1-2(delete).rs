...
// fn from_raw(ptr: *mut GreenTriviaData) -> Self {
//     if let Some(ptr) = ptr.as_ref() {
//         let arc = unsafe { Arc::from_raw(&ptr.data as *const ReprThin) };
//         let arc = unsafe { mem::transmute::<Arc<ReprThin>, ThinArc<GreenTriviaHead, TriviaPiece>>(arc) };
//         Self { ptr: Some(arc) }
//     } else {
//         Self { ptr: None }
//     }
